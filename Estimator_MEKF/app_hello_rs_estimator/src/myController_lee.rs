use crate::estimator_bindings::{self, control_t, sensorData_t, setpoint_t, state_t};
...
impl controller_Lee {
    ...
    pub fn controller_Lee(&mut self, control: *mut control_t, setpoint: *const setpoint_t, sensors: *const sensorData_t, state: *const state_t, _tick: u32) {
        unsafe {
            if !sensors.is_null() {
                ...
                */
                ...
                control_ref.controlMode = estimator_bindings::control_mode_e_controlModeForceTorque;
                control_ref.__bindgen_anon_1.__bindgen_anon_2 = estimator_bindings::control_s__bindgen_ty_1__bindgen_ty_2 {
                    thrustSi: f,
                    __bindgen_anon_1: estimator_bindings::control_s__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1 {
