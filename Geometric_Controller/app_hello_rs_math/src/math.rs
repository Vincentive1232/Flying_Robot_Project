...
use crate::stabilizer_types::{self, quaternion_s, vec3_s};
extern crate libm;
...
impl From<Quaternion> for quaternion_s {
    fn from(r_quaternion: Quaternion) -> Self {
        ...
        let q2 = stabilizer_types::quaternion_s__bindgen_ty_1__bindgen_ty_2 { w: r_quaternion.qw, x: r_quaternion.qx, y: r_quaternion.qy, z: r_quaternion.qz };

        let __bindgen_anon_1_data = stabilizer_types::quaternion_s__bindgen_ty_1 { __bindgen_anon_2: q2 };
